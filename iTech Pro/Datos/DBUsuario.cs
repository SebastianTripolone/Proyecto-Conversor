...
namespace iTech_Pro.Datos
{
    public class DBUsuario
    {
        private static string CadenaSQL = "Data Source=SQL5113.site4now.net;Initial Catalog=db_aa74ea_dbprueba;User Id=db_aa74ea_dbprueba_admin;Password=Sebita1978*";
